package com.example.tailorz.payment;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_activiyt);
        ...
        System.out.println("Logs: orderRefNum : " +orderRefNumString);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if(redirect_url.equals(POST_BACK_URL1)) {
                ...
                Intent i = new Intent(PaymentActivity.this, CustomerMain.class);
                String[] values = response.split("&");
                for (String pair : values) {
                    String[] nameValue = pair.split("=");
                    if (nameValue.length == 2) {
